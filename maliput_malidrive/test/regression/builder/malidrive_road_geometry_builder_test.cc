  ...
  return {/*
          ...
          */
          {"TShapeRoad",
           ...
           {
               {JunctionId("0_0"), {{{SegmentId("0_0"), 0, 46.}, {{0, 0, 1}, {0, 0, -1}}}}},
               {JunctionId("1_0"), {{{SegmentId("1_0"), 0, 46.}, {{1, 0, 1}, {1, 0, -1}}}}},
               {JunctionId("2_0"), {{{SegmentId("2_0"), 0, 46.}, {{2, 0, 1}, {2, 0, -1}}}}},
               {JunctionId("3"),
          ...
          */
          {"LineMultipleSections",
           ...
           {{1 /* road_id */, 0.0 /* heading */}},
           {{JunctionId("1_0"), {{{SegmentId("1_0"), 0, 33.3}, {{1, 0, -1}, {1, 0, 1}}}}},
            {JunctionId("1_1"), {{{SegmentId("1_1"), 33.3, 66.6}, {{1, 1, -1}, {1, 1, 1}}}}},
            {JunctionId("1_2"), {{{SegmentId("1_2"), 66.6, 100.}, {{1, 2, -1}, {1, 2, 1}}}}}}}};
}
