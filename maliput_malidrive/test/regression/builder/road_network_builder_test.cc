...
std::vector<VehicleRulesStateProviderTruthTable> InstantiateVehicleRulesStateProviderTestParameters() {
  return {
      {"odr/TShapeRoad.xodr",
       {
           {LaneId("0_0_1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("0_0_-1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("1_0_1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("1_0_-1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("2_0_1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("2_0_-1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("4_0_1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("5_0_-1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("6_0_-1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("7_0_-1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("8_0_-1"), rules::VehicleUsageRuleTypeId()},
           {LaneId("9_0_-1"), rules::VehicleUsageRuleTypeId()},
       }},
      {"odr/BikingLineLane.xodr",
       {
